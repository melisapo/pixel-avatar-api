      ...
      <header class="p-2 md:px-6 xl:px-20 ">
        <div class="flex items-center justify-between px-4 py-2 md:px-6 md:py-3 pixel-border bg-cornsilk font-display text-xl md:text-3xl font-bold">
            ...
            <div class="flex items-center justify-center gap-4 md:gap-6">
                <a href="#docs" class="text-grape hover:text-periwinkle text-lg md:text-2xl font-display font-bold">Docs</a>
                <a href="https://github.com/melisapo/pixel-avatar-api" class="text-grape hover:text-periwinkle">
