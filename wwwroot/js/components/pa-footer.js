class PaFooter extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
      <footer class="flex items-center justify-center pb-4 md:pb-8 font-display text-xl md:text-2xl font-semibold gap-6">
            <a href="/" class="text-grape/80 hover:text-grape">
